(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('js-helpers/dist/json/tryParseJson')) :
    typeof define === 'function' && define.amd ? define(['exports', 'js-helpers/dist/json/tryParseJson'], factory) :
    (global = global || self, factory(global.VueSdata = {}, global.tryParseJson));
}(this, (function (exports, tryParseJson) { 'use strict';
        ...
        Vue.mixin({
            methods: {
                getSData: function getSData(pName) {
                    ...
                    return isTryParse ? tryParseJson.tryParseJson(value) : value;
                },
                getJSData: function getJSData(pName) {
                    ...
                    return isTryParse ? tryParseJson.tryParseJson(SData$1.get(pName, def)) : SData$1.get(pName, def);
                }
            }
        });
    }
